...
function Upcoming() {
  ...
  useEffect(async ()=>{
    const res = await axios.get(`https://api.themoviedb.org/3/movie/upcoming?api_key=813fc636b6c680f1e28a60bab5837918&language=en-US&page=${currPage}`)
    let data = res.data
  ...
  <>
      {
        ...
        <div>
          <h2 className='text-center'><strong>Upcoming Movies</strong></h2>
